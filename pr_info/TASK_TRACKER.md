...
- [ ] [Step 1: Add `_apply_pr_merge_override()` pure function + tests](./steps/step_1.md)
- [ ] [Step 2: Update `_collect_pr_info()` to return `mergeable` + update tests](./steps/step_2.md)
