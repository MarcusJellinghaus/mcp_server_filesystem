...
<head>
    ...
    <title>MCP Workspace - Dependency Graph</title>
...
<body>
    <h1>MCP Workspace - Module Dependency Graph</h1>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>MCP Workspace - Dependency Report</title>
    <style>
        body {{
            font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
            margin: 0;
...
<body>
    <h1>MCP Workspace - Dependency Report</h1>
